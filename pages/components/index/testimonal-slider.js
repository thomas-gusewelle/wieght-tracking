    ...
    <div className="pb-6">
      ...
      <div className="flex justify-center gap-3">
        <button
          ...
          onClick={() => setSliderSwitch(1)}
        />
        <button
          className={`h-3 ${
            sliderSwitch === 2 ? "w-6 bg-green-500" : "w-3 bg-white"
          } transition-all duration-200 ease-in-out rounded-full`}
          onClick={() => setSliderSwitch(2)}
        />
        <button
          className={`h-3 ${
            sliderSwitch === 3 ? "w-6 bg-green-500" : "w-3 bg-white"
          } transition-all duration-200 ease-in-out rounded-full`}
          onClick={() => setSliderSwitch(3)}
        />
      </div>
    </div>
  );
            ...
            >
              {
                <p>
                  ...
                  Lossize helps me stay on top of my weight and easily see my
